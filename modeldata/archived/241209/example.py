...
from .settings import setModel, multiLevelDmsKey
from .get import run
from pytools import timetools as tt

if __name__ == '__main__':
  DIRROOT = '/nwpr/gfs/com120/9_data/models/'
  SERIAL  = tt.float2format( tt.now(), '%s')
  MIDFILE = f'./tmp_{SERIAL}.grb2'
